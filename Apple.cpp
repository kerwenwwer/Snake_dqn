...
int Apple::GetAppleX() { return x; }

int Apple::GetAppleY() { return y; }

bool Apple::AppleCreatedOnSnake(int AppleX, int AppleY,
                                const vector<vector<int> >& SnakeCells) {
