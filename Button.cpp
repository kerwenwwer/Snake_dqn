...
Button::Button(int button_width_percentage, int button_height_percentage,
               ALLEGRO_COLOR color, int dx, int dy) {
  ...
  button_x2 = (((CurrentScreenWidth - button_width) / 2) + button_width) +
              button_x_displacement;
  button_y1 =
      ((CurrentScreenHeight - button_height) / 2) + button_y_displacement;
  button_y2 = (((CurrentScreenHeight - button_height) / 2) + button_height) +
              button_y_displacement;
...
void Button::DisplayButton() {
  al_draw_filled_rounded_rectangle(button_x1, button_y1, button_x2, button_y2,
                                   7, 7, button_color);
}

void Button::SetButtonColor(ALLEGRO_COLOR color) { button_color = color; }
...
int Button::GetButtonX1() { return button_x1; }

int Button::GetButtonY1() { return button_y1; }

int Button::GetButtonX2() { return button_x2; }

int Button::GetButtonY2() { return button_y2; }
